...
export default function Home() {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #0c1a3a 50%, #0f2027 100%)' }}>
      {/* Auth loading state */}
      {!authChecked && (
        <div className="absolute inset-0 z-50 flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #0c1a3a 50%, #0f2027 100%)' }}>
          <div className="flex flex-col items-center gap-4">
            <svg className="animate-spin h-10 w-10 text-sky-400" viewBox="0 0 24 24" fill="none">
