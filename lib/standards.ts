...
export const WATER_STANDARDS: Record<string, {
  ...
  // ─── 参考基准 ───
  WHO: {
    name: 'WHO 国际标准', nameEn: 'WHO International', flag: '🌍', standard: 'WHO GDWQ 2022',
  ...
  // ─── 亚洲 ───
  CN: {
    name: '中国', nameEn: 'China', flag: '🇨🇳', standard: 'GB 5749-2022',
    authority: '国家卫生健康委员会',
    region: '亚洲',
  ...
  JP: {
    name: '日本', nameEn: 'Japan', flag: '🇯🇵', standard: '水道法 (2020)',
    authority: '厚生労働省',
    region: '亚洲',
  ...
  KR: {
    name: '韩国', nameEn: 'South Korea', flag: '🇰🇷', standard: '먹는물 수질기준 (2021)',
    authority: '環境部',
    region: '亚洲',
  ...
  IN: {
    name: '印度', nameEn: 'India', flag: '🇮🇳', standard: 'IS 10500:2012',
  ...
  SG: {
    name: '新加坡', nameEn: 'Singapore', flag: '🇸🇬', standard: 'ENV PUB Standards (2019)',
  ...
  TH: {
    name: '泰国', nameEn: 'Thailand', flag: '🇹🇭', standard: 'TIS 257-2549',
  ...
  // ─── 欧洲 ───
  EU: {
    name: '欧盟', nameEn: 'European Union', flag: '🇪🇺', standard: 'EU Directive 2020/2184',
  ...
  GB: {
    name: '英国', nameEn: 'United Kingdom', flag: '🇬🇧', standard: 'Water Supply Regulations 2016',
  ...
  DE: {
    name: '德国', nameEn: 'Germany', flag: '🇩🇪', standard: 'Trinkwasserverordnung 2023',
  ...
  FR: {
    name: '法国', nameEn: 'France', flag: '🇫🇷', standard: 'Arrêté du 11 janvier 2007',
  ...
  // ─── 北美洲 ───
  US: {
    name: '美国', nameEn: 'United States', flag: '🇺🇸', standard: 'EPA NPDWR 2023',
  ...
  CA: {
    name: '加拿大', nameEn: 'Canada', flag: '🇨🇦', standard: 'Health Canada GCDWQ 2020',
  ...
  MX: {
    name: '墨西哥', nameEn: 'Mexico', flag: '🇲🇽', standard: 'NOM-127-SSA1-2021',
  ...
  // ─── 大洋洲 ───
  AU: {
    name: '澳大利亚', nameEn: 'Australia', flag: '🇦🇺', standard: 'ADWG 2022 (NHMRC)',
  ...
  NZ: {
    name: '新西兰', nameEn: 'New Zealand', flag: '🇳🇿', standard: 'DWSNZ 2022',
  ...
  // ─── 南美洲 ───
  BR: {
    name: '巴西', nameEn: 'Brazil', flag: '🇧🇷', standard: 'Portaria GM/MS 888/2021',
  ...
  // ─── 中东/非洲 ───
  SA: {
    name: '沙特阿拉伯', nameEn: 'Saudi Arabia', flag: '🇸🇦', standard: 'GSO 149/2009',
  ...
  ZA: {
    name: '南非', nameEn: 'South Africa', flag: '🇿🇦', standard: 'SANS 241:2015',
